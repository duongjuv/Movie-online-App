...
package com.example.movieonlineapp.ui.detail.activity.supportMedia;
...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    @SuppressLint("UseRequireInsteadOfGet") AppCompatDialog dialog =
        new AppCompatDialog(Objects.requireNonNull(getActivity()),
                R.style.TrackSelectionDialogThemOverLay);
  ...
  private static String getTrackTypeString(Resources resources, @C.TrackType int trackType) {
    switch (trackType) {
      case C.TRACK_TYPE_VIDEO:
        return resources.getString(R.string.track_selection_title);
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public View onCreateView(
      ...
      @SuppressLint("PrivateResource") View rootView =
          inflater.inflate(androidx.media3.ui.R.layout.exo_track_selection_dialog, container, false);
    ...
    public void onTrackSelectionChanged(
            boolean isDisabled, @NonNull Map<TrackGroup, TrackSelectionOverride> overrides) {
      this.isDisabled = isDisabled;
